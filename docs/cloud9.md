...
2. Details에서 이름을 m2m-workspace으로 입력합니다.
3. New EC2 Instance에서 인스턴스 타입(instance type)을 Additional instance type 라디오 버튼을 클릭 후, t3.medium으로 선택합니다. 플랫폼(platform)의 경우, Amazon Linux 2를 선택하고 하단의 Create를 클릭하여 생성합니다.
...
5. Role name에 m2m-admin을 입력한 후, AdministratorAccess 관리형 정책이 추가된 것을 확인하고 Create role을 클릭합니다.
